...
def default1():
    if request.method == 'POST':
        ...
        return render_template('caesar_cipher.html', ct=ct, pt=pt, key=key, text="Encrypted Text",
                               suggestion="Please Click on the text fields in order to view the Content!!")
    else:
...
def default2():
    if request.method == 'POST':
        ...
        return render_template('caesar_cipher.html', ct=pt, pt=ct, key=key, text="Decrypted Text",
                               suggestion="Please Click on the text fields in order to view the Content!!")
    else:
        return render_template("caesar_cipher.html", text='failure')
...
def encryption_vigener():
    if request.method == 'POST':
        ...
        return render_template('vigener_cipher.html', ct=ct, key=key, pt=pt, text="Encrypted Text",
                               suggestion="Please Click on the text fields in order to view the Content!!")
...
def decryption_vigener():
    if request.method == 'POST':
        ...
        return render_template('vigener_cipher.html', ct=pt, key=key, pt=ct, text="Decrypted Text",
                               suggestion="Please Click on the text fields in order to view the Content!!")
...
def encryption_vernam():
    if request.method == 'POST':
        ...
        return render_template('vernam_cipher.html', ct=ct, key=key, pt=pt, text="Encrypted Text",
                               suggestion="Please Click on the text fields in order to view the Content!!")
...
def decryption_vernam():
    if request.method == 'POST':
        ...
        return render_template('vernam_cipher.html', ct=pt, key=key, pt=ct, text="Decrypted Text",
                               suggestion="Please Click on the text fields in order to view the Content!!")
...
def encryption_playfare():
    if request.method == 'POST':
        ...
        return render_template('playfare_cipher.html', ct=ct, key=key, pt=pt, text="Encrypted Text",
                               suggestion="Please Click on the text fields in order to view the Content!!")
...
def decryption_playfare():
    if request.method == 'POST':
        ...
        return render_template('playfare_cipher.html', ct=pt, key=key,
                               key1="This is the key matrix which is generated by the key:" + key1, pt=ct,
                               text="Decrypted Text",
                               suggestion="Please Click on the text fields in order to view the Content!!")
...
def encryption_hill():
    if request.method == 'POST':
        ...
        return render_template('hill_cipher_display.html', ct=ct, pt=pt, key1=key, key=key, ans=ans,
                               text="Encrypted Text", size=size,
...
def decryption_hill():
    if request.method == 'POST':
        ...
        return render_template('hill_cipher_display.html', ct=txt, pt="", key1=key, key=key, text="Decrypted Text",
                               suggestion="Please Click on the text fields in order to view the Content!!\nIf you want to decrypt a text then write that text in Encrypted text field ")
    else:
        return render_template('hill_cipher_display.html', ct="", pt="", key="", text="Decrypted Text",
                               suggestion="Please Click on the text fields in order to view the Content!!\nIf you want to decrypt a text then write that text in Encrypted text field ")
